...
```{r summary, include = T, echo = F}
summary(sequence_counts)
```

```{r histogram, include = T, echo = F, fig.path='../results/figures/', fig.cap=T, fig.height=5, fig.width=5, fig.align='center', dev='svg'}
...
`r average_seqeunce_counts` pairs of reads per sample (95% of the samples
